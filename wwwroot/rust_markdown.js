...
* @returns {string}
*/
export function md_preview(input) {
    let deferred2_0;
    let deferred2_1;
    try {
        ...
        wasm.md_preview(retptr, ptr0, len0);
...
* @param {string} input
*/
export function md_dl(input) {
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.md_dl(ptr0, len0);
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('rust_markdown_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
